...
echo -e "\e[106m=======================================================\e[0m"
echo -e "\e[106m=======================================================\e[0m"
echo -e "\e[106m====================\e[43m======\e[0m\e[106m================================\e[0m"
echo -e "\e[107m===================\e[43m========\e[0m\e[107m===============================\e[0m"
echo -e "\e[107m===================\e[43m========\e[0m\e[107m===============================\e[0m"
echo -e "\e[106m====================\e[43m======\e[0m\e[106m================================\e[0m"
echo -e "\e[106m========================================================\e[0m"
echo -e "\e[106m=======================================================\e[0m"
...
echo "cd /etc/adm-lite && bash ./menu" > /bin/tommy
...
echo -e "\e[106m=======================================================\e[0m"
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[3]} $(source trans -b pt:${id} "INSTALACION DE TOMMY ARGENTINA - Pannel Instalada Correctamente!")"
echo -e "${cor[3]} |∆| ${cor[2]}$(source trans -b pt:${id} "Ahora puedes acceder al PANNEL")"
echo -e "${cor[3]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[2]} $(source trans -b pt:${id} "Use los Comandos"): tommy , menu, adm"
...
figlet $name | lolcat
echo "ADM\-"$name"-/TOMMY@ARGENTINA" > exito
rm -f instala.sh*
rm -f russel.sh*
}
...
echo -e ""
echo -e "${cor[1]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -e "${cor[5]} INSTALADOR TOMMY@ARGENTINA  ®"
echo -e "${cor[1]}●●●●●● ●●●●●● ●●●●●● ●●●●●● ●●●●●● ●●●●●● ●●●●●● ●●●●●● "
